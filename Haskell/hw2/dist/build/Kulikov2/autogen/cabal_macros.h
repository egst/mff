...
/* package Kulikov2-1.0.2 */
#ifndef VERSION_Kulikov2
#define VERSION_Kulikov2 "1.0.2"
#endif /* VERSION_Kulikov2 */
#ifndef MIN_VERSION_Kulikov2
#define MIN_VERSION_Kulikov2(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
  (major1) == 1 && (major2) == 0 && (minor) <= 2)
#endif /* MIN_VERSION_Kulikov2 */
...
#define CURRENT_COMPONENT_ID "Kulikov2-1.0.2-K6ZHvjoDmCvDdNuvfsYNAM-Kulikov2"
